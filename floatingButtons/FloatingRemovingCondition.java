...
public class FloatingRemovingCondition {
    ...
    public static void checkCollisionAndAnimate(final View floatingButton, final View deleteButton, final WindowManager windowManager, final WindowManager.LayoutParams layoutParams, final boolean moved) {
        if(moved){
